...
export class QuotationComponent {
  ...
  searchClient(name: string) {
    ...
    this.quotationService.searchClientsByName(name).subscribe(
      (clients) => {
        if (clients.length > 0) {
  ...
  searchProduct(name: string) {
    ...
    this.quotationService.searchProductsByName(name).subscribe(
      (products) => {
  ...
  createQuotation() {
    ...
    this.quotationService.reateQuotation(quotationData).subscribe(
      (response: Blob) => {
